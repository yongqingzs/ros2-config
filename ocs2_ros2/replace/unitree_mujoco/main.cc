...
int main(int argc, char **argv)
{
  ...
  YAML::Node yaml_node = YAML::LoadFile("/home/ocs2/quad_ws/src/unitree_mujoco/simulate/config.yaml");
  ...
  string scene_path = "/home/ocs2/quad_ws/src/unitree_mujoco/unitree_robots/" + config.robot + "/" + config.robot_scene;
